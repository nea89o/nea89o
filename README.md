...
\ce{$\text[monospace; content: "We've been trying to reach you about your cars extended warranty!"; z-index: 10; position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%); border: 3px solid red; background: grey;]{Test text}$}
